...
exports.aliasTopTours = exports.deleteTour = exports.updateTour = exports.createTour = exports.getTour = exports.getAllTours = void 0;
...
const getAllTours = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let query = tourModels_1.Tour.find(JSON.parse(queryString));
        if (req.query.sort) {
        ...
        if (req.query.page) {
            let count = yield tourModels_1.Tour.countDocuments();
            if (skip >= count)
